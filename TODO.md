...
- [ ] **API coverage:** 91 services across interface, vlib, and IP are supported, including nested trailing variable replies and TX-placement streaming with internal pagination. Remaining: event subscriptions, IP path-MTU stream continuation, arrays of variable-sized elements/non-trailing variable layouts, non-IP FIB next-hop conversion, additional modules, and hardware-backed multi-page TX validation.
