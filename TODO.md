...
- [ ] **API coverage:** 85 services across interface, vlib, and IP are supported, including trailing variable replies and TX-placement streaming with internal pagination. Remaining: event subscriptions, nested variable replies, other stream continuation policies/modules, and hardware-backed multi-page TX validation.
