...
Json Capabilities(const Options& options) {
  return {{"protocol", 1},
          ...
          {"max_params_bytes", Limits::kParamsBytes},
          {"max_record_bytes", Limits::kRecordBytes},
          {"max_native_payload_bytes", Limits::kNativePayloadBytes},
          {"response_fragments", "base64-json"},
